    ...
    var profilePicture: some View {
        ZStack{
            ...
            Image("Profile")
                ...
                .frame(width: 66, height: 66)
                .cornerRadius(50)
                .overlay(Circle().stroke(Color.white, lineWidth: 1).blendMode(.overlay))
        }
    }
    ...
    var glowIcon: some View {
        ZStack {
            ...
            Image(systemName: "square.stack.fill")
                ...
                .overlay(RoundedRectangle(cornerRadius: 12, style: .continuous).stroke(Color.white, lineWidth: 1).blendMode(.overlay))
        }
    }
}
